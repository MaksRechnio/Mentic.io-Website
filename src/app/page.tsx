            ...
            <div id="hero-alpha" style={{
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.background = "#a8f7df";
                  el.style.color = "#003c46";
                  el.style.letterSpacing = "1.6px";
                  el.style.boxShadow = "0 4px 18px rgba(139,242,211,0.45)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget;
                  el.style.background = "#8bf2d3";
                  el.style.color = "#003c46";
                ...
                style={{
                  ...
                  border: "1.5px solid #8bf2d3",
                  borderRadius: 999,
                  background: "#8bf2d3",
                  fontSize: m ? 12 : 14, fontWeight: 700,
                  color: "#003c46", letterSpacing: "1.2px",
